...
import {
  ...
  Shield } from
'lucide-react';
import { submitPublicLead } from '@/services/cases';
import { createInvitation } from '@/services/admin';
...
export default function FindLawyer() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      // Submit lead via edge function (handles lead creation, Lead Docket sync, consent log, emails, audit log)
      ...
      // Handle attorney invitation if provided (fire-and-forget)
      if (formData.invite_attorney_email) {
        try {
          ...
          console.log('Attorney invitation attempted');
        }
      }
