      ...
      <div className="min-h-screen bg-[#faf8f5]">
        ...
        <div className="pt-32 pb-24 px-4">
          ...
          >
            ...
            <h1 className="text-4xl font-bold text-gray-900 mb-4">You're in the Approval Queue!</h1>
      ...
      <div className="min-h-screen bg-[#faf8f5]">
        ...
        <section className="py-20 bg-[#faf8f5]">
          <div className="max-w-3xl mx-auto px-4 text-center">
            ...
            <p className="text-gray-600 mb-8">Submit your application. Once approved, you'll get full access to browse and accept cases.</p>
      ...
      <div className="pt-24 pb-20 px-4">
        <div className="max-w-2xl mx-auto">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 mt-2">Complete all steps to submit your application for review</p>
          </div>
              ...
              <TMLCard variant="elevated" className="p-8">
                ...
                {step === 1 && (
                  <div className="space-y-5">
                    ...
                    <p className="text-gray-500 text-sm mb-4">Tell us about yourself and your firm.</p>
                ...
                <div className="flex justify-between mt-8 pt-6 border-t border-gray-100">
                  ...
                  {step === 1 && (
                    <TMLButton variant="primary" onClick={handleStep1Next}>
