  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.data?.success) {
        ...
        setError('This activation link has already been used. Please log in or contact support if you need help.');
      } else {
        ...
        <div className="flex items-center justify-center py-24 px-4">
          <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="max-w-md w-full">
            <div className="bg-white rounded-2xl shadow-xl text-center p-10">
              ...
              <p className="text-gray-600 mb-4">Your account is ready. Redirecting you to sign in...</p>
      ...
      <div className="flex items-center justify-center py-16 px-4 pt-28">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-md">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-500 mt-2">Create a secure password to access your attorney portal</p>
          </div>
